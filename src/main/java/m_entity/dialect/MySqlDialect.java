...
public class MySqlDialect implements SqlDialect {
    ...
    @Override
    public List<String> createDropTableSql(DDLTableMetadata table) {
    ...
    @Override
    public String createTableDefinitionSql(DDLTableMetadata table) {
    ...
    private String buildColumnSql(DDLColumnMetadata col) {
        StringBuilder sb = new StringBuilder();
    ...
    @Override
    public List<String> createAlterTableSql(DDLTableMetadata table, DDLColumnMetadata col, HashMap<String, List<String>> parentFieldTypes) {
    ...
    @Override
    public String createAddColumnIfNotExistsSql(DDLTableMetadata table, DDLColumnMetadata col) {
