package m_entity.processor;

import m_entity.client.AutoDDLPolicy;
import m_entity.generator.domain.policy.ddl_script_builder.DDLScriptBuilder;
...
import m_entity.generator.infra.MyBatisDDLDirectExecutor;
import m_entity.generator.domain.policy.my_batis_ddl_executor_source_write.MyBatisXMLDDLExecutorSourceWriter;
...
public class MEntityAstProcessor {
    ...
    public MEntityAstProcessor(
        ...
        this.loader = new DDLMetaDataLoaderAstImplV2(processingEnv, roundEnv);
    ...
    public void generate() {
        try {
            ...
            if(shouldExecute)
            {
                new MyBatisDDLDirectExecutor(processingEnv.getMessager())
