...
import m_entity.client.OnDeleteType;
import m_entity.valid.MFieldValidator;
...
public class MObjectFactoryV2 {
    ...
    public static MField createMVariableV2(List<MFieldParserV2.Pair> pairs) {
        MField.Builder builder = MField.builder();

        // 1. 변수명(fieldName)을 기본 컬럼명으로 먼저 설정
        // 만약 체이닝에서 .name("...")이 나오면 뒤에서 덮어쓰게 됩니다.
        for (MFieldParserV2.Pair pair : pairs) {
