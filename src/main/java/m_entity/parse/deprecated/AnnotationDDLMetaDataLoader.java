package m_entity.parse.deprecated;
...
import m_entity.parse.infra.deprecated.AnnotationUtil; // 파일 경로 얻는 유틸 (기존 유지)
import m_entity.generator.domain.vo.DDLTableMetadata;
import m_entity.parse.domain.vo.MEntityInfo;
import m_entity.parse.infra.deprecated.MetadataCache;
