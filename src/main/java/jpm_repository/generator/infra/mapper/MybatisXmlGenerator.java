package jpm_repository.generator.infra.mapper;

import config.AppConfig;
import jpm_repository.parse.domain.vo.EntityMeta;
import jpm_repository.parse.domain.vo.MapJoinMeta;
...
public class MybatisXmlGenerator {
    ...
    private String toColumnName(String rawArg) {
        ...
        if (rawArg.contains("::")) {
            ...
            EntityMeta targetMeta = REPO_META_REGISTRY.getEntityMeta(className);
            if (targetMeta != null) {
