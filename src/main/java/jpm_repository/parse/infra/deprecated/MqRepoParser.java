package jpm_repository.parse.infra.deprecated;
...
import jpm_repository.parse.domain.vo.*;
...
public class MqRepoParser {
    ...
    private static void inlineSegmentMethod(String repoPath, String segmentMethodName, MethodMeta methodMeta, List<String> passedArgs) {
        ...
        String segmentPath = REPO_META_REGISTRY.getSegmentPath(repoPath, segmentMethodName);
