...
public class FromSubQueryNodeV2 implements SqlNode {
    private final List<DslStatementV2> subStatements;
    private final EntityMeta entityMeta;
    private final String alias;
    private final SqlNodeParserStepsV2 nodeParser;

    public FromSubQueryNodeV2(DslStatementV2 stmt, List<DslStatementV2> subStatements, EntityMeta entityMeta, SqlNodeParserStepsV2 nodeParser) {
        ...
        this.alias = (args != null && !args.isEmpty()) ? args.get(0).toString() : "sub";
    }
    ...
    public String toSql(BuildContext ctx) {
        ...
        String innerSql = nodeParser.generateSqlFromStatements(subStatements);
