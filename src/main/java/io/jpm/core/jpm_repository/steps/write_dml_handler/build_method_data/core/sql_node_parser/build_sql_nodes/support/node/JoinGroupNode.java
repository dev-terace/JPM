...
public class JoinGroupNode implements SqlNode {
    ...
    public JoinGroupNode(String cmd, List<String> args, List<DslStatement> subStatements, EntityMeta entityMeta, SqlNodeParserSteps nodeParser, RepoMetaRegistry repoMetaRegistry) {
