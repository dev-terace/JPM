...
import io.jpm.core.jpm_repository.steps.find_repo_meta_handler.infra.parse_method_body_step.ParseMethodBodySteps;
...
public class CompositeParseMemberMethodStep implements CompositeStep<MethodParseContext> {
    ...
    public CompositeParseMemberMethodStep(GlobalRegistry globalRegistry, AstContext astContext) {
        steps = Arrays.asList(
                ...
                new ParseMethodBodySteps(globalRegistry, astContext)
        );
    }
