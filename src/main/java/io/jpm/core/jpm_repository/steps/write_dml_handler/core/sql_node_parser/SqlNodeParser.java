            ...
            for (int i = 0; i < statements.size(); i++) {
                ...
                switch (cmd) {
                    ...
                    case "fromGroup": {
                        ...
                        i += sub.size() + 1;
                        nodes.add(new FromSubQueryNode(stmt, sub, entityMeta, null));
                        break;
                    }
                    ...
                    case "leftJoinGroup": {
                        List<DslStatement> sub = GroupExtractorUtil.extract(statements, i);
                        i += sub.size() + 1;
                        nodes.add(new JoinGroupNode(cmd, args, sub, entityMeta, null, repoMetaRegistry));
                        break;
                    }
                    ...
                    case "whereNotExistsGroup": {
                        ...
                        whereClause.addCondition(new ExistsNode(cmd, sub, entityMeta, repoMetaRegistry, null));
                        break;
                    }
